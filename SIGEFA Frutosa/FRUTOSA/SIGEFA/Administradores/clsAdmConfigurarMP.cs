...
{
    class clsAdmConfigurarMP
    {
        IConfigurarMP Mcar = new MysqlConfigurarMP();
        ...
        public Boolean delete(Int32 CodPadre)
        {
            try
            {
                return Mcar.Delete(CodPadre);
            }
            catch (Exception ex)
            {
        ...
        public DataTable MuestraConfiguracionMP(Int32 codPadre)
        {
            try
            {
                return Mcar.ListaConfiguracionMP(codPadre);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
