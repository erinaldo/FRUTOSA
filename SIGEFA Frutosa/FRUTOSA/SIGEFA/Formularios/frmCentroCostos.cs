...
{
    public partial class frmCentroCostos : DevComponents.DotNetBar.OfficeForm
    {
        ...
        private void CargaLista() {
            dgvAreas.DataSource = admcentro.ListaCentros(0);
        ...
        private void btnLineas_Click(object sender, EventArgs e)
        {
            ...
            if (dgvAreas.RowCount == 0)
                ...
                frmCentroCostos2 form = new frmCentroCostos2();
