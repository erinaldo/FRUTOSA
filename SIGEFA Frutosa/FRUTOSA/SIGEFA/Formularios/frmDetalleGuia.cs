...
namespace SIGEFA.Formularios
{
    public partial class frmDetalleGuia : DevComponents.DotNetBar.OfficeForm
    {
        ...
        private void txtCodigo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtCodigo.Text != "")
            {
               ...
               //     txtStock.Text = pro.StockDisponible.ToString();
                    ...
                    else if (pro.CodFamilia == 8 || pro.CodFamilia == 9)//JUGOS
                    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (txtReferencia.Text == "" || txtCantidad.Text == "")
            {
            ...
            else
            {
                ...
                if (Procede == 14)
                {
                    ...
                    else
                    {
                        ...
                        if (Proceso == 1)
                        {
                            ...
                            form.codFamilia = pro.CodFamilia;
                ...
                if (Procede == 16)//
                {
                    ...
                    else
                    {
                        ...
                        form.codProdMatPrima = pro.CodProducto;
                        this.Close();
                    }
                }
   ...
   //         this.Close();
        ...
        {
            if (textBox3.Text != "" && pro!= null)
            {
                

                if (Convert.ToDouble(textBox3.Text) > 0 && pro.CodFamilia == 8 )
