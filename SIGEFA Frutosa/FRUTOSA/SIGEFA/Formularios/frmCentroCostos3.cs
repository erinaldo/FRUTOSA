...
{
    public partial class frmCentroCostos3 : DevComponents.DotNetBar.OfficeForm
    {
        ...
        {
            dgvAreas.DataSource = admcentro.ListaCentrosNivel(3);

        }

        private void frmCentroCostos3_Load(object sender, EventArgs e)
        {
       //     btnLineas.Text = "Nivel " + Param;
        ...
        private void dgvAreas_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (Proceso == 3)//frmNotaIngreso
            {
                ...
                form.codCentro = centro.Codcentro;
            }
        ...
        private void btnLineas_Click(object sender, EventArgs e)
        {
            ...
            if (dgvAreas.RowCount == 0)
                ...
                form.Param = this.Param + 1;
                form.codPadre = centro.Codcentro;
          //      form.MdiParent = this;
                form.ShowDialog();
