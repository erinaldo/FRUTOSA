...
{
    public partial class frmSalidasProd : DevComponents.DotNetBar.OfficeForm    
    {
        ...
        private void CargaLista(Int32 caso)
        {
            ...
            data.DataSource = AdmProd.ListaTotalSalProd(codTipoArt, frmLogin.iCodAlmacen, dtpDesde.Value.Date, dtpHasta.Value.Date);
        ...
        private void frmSalidasProd_Load(object sender, EventArgs e)
        {
...
/*
        ...
        private void cmbTipoDocumento_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbTipoDocumento.SelectedIndex == 0)
            {
                ...
                FechaIngreso.Visible = true;

                GradosBrix.Visible = false;
                PesoNeto.Visible = false;
                Series.Visible = false;
                codTipoArt = 5;

            }
            else if (cmbTipoDocumento.SelectedIndex == 1 || cmbTipoDocumento.SelectedIndex == 2)
            {
