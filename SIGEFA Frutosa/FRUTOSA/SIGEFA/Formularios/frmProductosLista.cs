...
namespace SIGEFA.Formularios
{
    public partial class frmProductosLista : DevComponents.DotNetBar.OfficeForm
    {
        ...
        private void frmProductosLista_Load(object sender, EventArgs e)
        {
            ...
            if (alm.ITipoAlm == 7)//SUMINISTROS DIVERSOS
                cbTipoArticulo.SelectedValue = alm.ITipoAlm;
            if (alm.ITipoAlm == 5)//MP
            {
                cbTipoArticulo.SelectedValue = alm.ITipoAlm;
            ...
            if (alm.ITipoAlm == 6)//INSUMOS
                cbTipoArticulo.SelectedValue = alm.ITipoAlm;

            if (alm.ITipoAlm == 8)//PT
            {
                cbTipoArticulo.SelectedValue = alm.ITipoAlm;
                stockdisponible.Visible = true;
        ...
        private void CargaLista(Int32 proce)
        {
            ...
            else if (Procede == 20 || Procede == 21 || Procede == 23 )// frmRptCentroCostos
            {
        ...
        private void dgvProductos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (Procede == 23)//frmSalidaArticulo
            {
                frmParamIngMatprima form = (frmParamIngMatprima)Application.OpenForms["frmParamIngMatprima"];
                form.CodProducto = pro.CodProducto;
                form.txtUnArt.Text = pro.Descripcion;
            }
            this.Close();
