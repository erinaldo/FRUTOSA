...
namespace SIGEFA.Administradores
{
    class clsAdmBahia
    {
        ...
        public clsBahia MuestraBahia(Int32 CodBahia)
        {
            try
            {
                return Maut.CargaBahia(CodBahia);
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public DataTable MuestraBahias()
        {
            try
            {
                return Maut.ListaBahias();
            }
            catch (Exception ex)
            {
                DevComponents.DotNetBar.MessageBoxEx.Show("Se encontró el siguiente problema: " + ex.Message, "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
