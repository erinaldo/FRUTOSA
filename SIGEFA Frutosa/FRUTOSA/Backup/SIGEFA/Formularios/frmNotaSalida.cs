    ...
    public partial class frmNotaSalida : DevComponents.DotNetBar.OfficeForm
    {
        ...
        private void btnDetalle_Click(object sender, EventArgs e)
        {
            ...
            if (CodTransaccion == 23)//salida a Produccion
            {
                ...
                else
                {
                    ...
                    else if (calm.ITipoAlm == 0 || calm.ITipoAlm == 2)
                    ...
                    if (Proceso != 0)
                    {
                        ...
                        if (Proceso == 1)
                        {
                            if (AdmNota.insert(nota))
                            {
                                ...
                                if (CodTransaccion == 23 && calm.ITipoAlm == 1)
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CodTransaccion == 23)//SALIDA A PRODUCCIÓN
                {
                    ...
                    rpt.SetDataSource(ds.getSalidaProduccion(Int32.Parse(CodNota),CodLote).Tables[0]);
