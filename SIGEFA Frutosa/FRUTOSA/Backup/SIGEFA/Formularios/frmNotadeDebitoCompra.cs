...
{
    public partial class frmNotadeDebitoCompra : DevComponents.DotNetBar.OfficeForm
    {
            ...
            try
            {
                ...
                if (factur != null)
                {
                    ...
                    if (txtCodProveedor.Enabled)
                    {
                        ...
                        //cmbFormaPago.SelectedValue = f.FormaPago;
                    }
