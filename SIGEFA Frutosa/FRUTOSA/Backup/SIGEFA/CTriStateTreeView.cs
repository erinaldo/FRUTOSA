...
namespace SIGEFA
{
    public partial class CTriStateTreeView : System.Windows.Forms.TreeView
    {
        // <remarks>
		...
		// </remarks>
		public enum CTriStateStyles : int { Standard = 0, Installer };
		...
		protected void UpdateParentState(System.Windows.Forms.TreeNode tn)
		{
			...
			if (TriStateStyle == CTriStateStyles.Installer)
			{
